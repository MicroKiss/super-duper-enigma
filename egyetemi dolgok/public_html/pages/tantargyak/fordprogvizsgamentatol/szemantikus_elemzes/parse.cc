// Generated by Bisonc++ V5.02.00 on Wed, 15 Jan 2020 16:31:51 +0100
...
PI__ const s_productionInfo[] = 
{
     ...
     {325, 1}, // 27: kifejezes (VALOS_SZAM) ->  VALOS_SZAM
     ...
     {325, 4}, // 45: kifejezes (TORT_RESZ) ->  TORT_RESZ BALZAROJEL kifejezes JOBBZAROJEL
     {325, 4}, // 46: kifejezes (EGESZ_RESZ) ->  EGESZ_RESZ BALZAROJEL kifejezes JOBBZAROJEL
...
#line 226 "grammar.y"
        {
         if( szimb_tabla.count( *d_vsp__[0].szoveg ) == 0 || szimb_tabla[*d_vsp__[0].szoveg].vtip == Valos )
         {
         std::cerr << d_loc__.first_line << ": A(z) '" << *d_vsp__[0].szoveg << "' valtozo nincs deklaralva vagy valos szam." << std::endl;
         exit(1);
         }
         else
         {
